        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="../uploads/<?= htmlspecialchars($lot['img']); ?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартоваая цена</span>
                            <span class="lot__cost"><?= sum_format(htmlspecialchars($lot['start_price'])); ?></span>
                        </div>
                        <?php $res = get_dt_range(htmlspecialchars($lot['date_finish'])); ?>
